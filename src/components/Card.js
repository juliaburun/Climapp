  ...
  return (
...

    {
        showData === true ? (
                ...
                <div className='card mb-3 mx-auto bg-dark text-light'>
                    <div className='row g-0'>
                        <div className='col-md-4'>
                            ...
                            <img src='nubes2.jpg'className='img-fluid rounded-start' alt='nubes' />
                        </div>
                        <div className='col-md-8'>
                            ...
                            <div className='row mt-4'>
                                <div className='col'>
                                    ...
                                    <p className='description'><img src={iconUrl3} alt="icono"/>{forecast.list[1].weather[0].description}</p>
                                    <p className='temp'>{(forecast.list[1].main.temp - 273.15).toFixed(1)}ºC</p>
                                </div>
                                <div className='col'>
                                    <p>{forecastDate6}hs</p>
                                    <p className='description'><img src={iconUrl6} alt="icono"/>{forecast.list[2].weather[0].description}</p>
                                    <p className='temp'>{(forecast.list[2].main.temp - 273.15).toFixed(1)}ºC</p>
                                </div>
                                <div className='col'>
                                    <p>{forecastDate9}hs</p>
                                    <p className='description'><img src={iconUrl9} alt="icono"/>{forecast.list[3].weather[0].description}</p>
            ...
            <h2 className='text-light'>Escriba el nombre de una ciudad</h2>
        )
    }
